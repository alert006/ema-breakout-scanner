...
MONITORING_LIST = [    "RELIANCE", "TCS", "HDFCBANK", "ICICIBANK", "KOTAKBANK", "INFY", "SBIN", "LT",
    ...
    "^NSEI", "^NSEBANK", "^NSEINFRA", "^BSESN", "ABBOTINDIA", "ABCAPITAL", "ABFINFRA", "ABSOLAR", "ADANIPOWER", "ADANIPORTSGREEN", "AFTL", "AGRITECH", "AKZOINDIA", "ALBK", "ALEMBICHEM", "ALKEM", "ALLCARGO", "ALLCARGOLOG", "ALLIANZ", "ALLOCAPITAL", "AMBERTECH", "AMBUJACEMENT", "AMJLAND", "AMLSEC", "AMRAPALIGROUP", "AMTL", "ANANTRAJ", "ANDHRACEMET", "ANDHRA CEMENT", "ANDROGENTECH", "ANGELBROKING", "ANIKAENGG", "ANILEXPORTS", "ANMOL", "ANRITSU", "ANSAFARMS", "ANTRIGSYS", "APLASMEDI", "APARC", "APL", "APLLTD", "APOLLOHOSPITAL", "APOLLOTIRES", "APOLLOTRADER", "APPLIEDSTEEL", "APSEZ", "APTECH", "AQURON", "ARABINDAORG", "ARADHAN", "ARAVIND", "ARCARC", "ARCHIDPLY", "ARCSSOFT", "ARFINFRA", "ARGONTECH", "ARIHANTCAP", "ARIHANTSUP", "ARIHANTSUPP", "ARJUNPHARMA", "AROGYAHEALTH", "AROMAEXPORT", "AROMATIC", "ARORA", "ARROW", "ARSHIYA", "ARTEEINFRA", "ARTH", "ARTHAUDITORS", "ARTIES", "ARUNA", "ARUNATEX", "ARVINDFASH", "ARYAMAR", "ARYAN", "ARYANDYES", "ARYAVART", "ASAHIBEVERAGE", "ASAHISECURITIES", "ASAHISUSPENDERS", "ASAP", "ASHAPURAMIN", "ASHAWOOD", "ASHINFRACITY", "ASIANBREASTFE", "ASIANFOODSIN", "ASIANHOTELS", "ASIANINSURANCE", "ASIANORGANICS", "ASIANPAINTS", "ASIANPLAST", "ASIANRINDS", "ASIANSEC", "ASIANSEXPORTERS", "ASIANSINFRA", "ASIANSMOTOR", "ASIANSOUP", "ASIANSPORTIND", "ASIANSUN", "ASIANTEXTILE", "ASIATECH", "ASIBTD", "ASICCAGRI", "ASICEMENT", "ASIDIESEL", "ASIELEC", "ASIFEEDS", "ASIFOODS", "ASIGA", "ASIINDIA", "ASIJ", "ASILEATHER", "ASILINE", "ASIMETH", "ASIN", "ASINDUSTRY", "ASINFRA", "ASINODIA", "ASIONLY", "ASIOPTIC", "ASIOPTIONS", "ASIPHARMA", "ASIPOWER", "ASIPRECISION", "ASIRENOVATION", "ASIRENTS", "ASISCHEME", "ASISEC", "ASISERVICES", "ASISSECURITIES", "ASISTAN", "ASITAX", "ASITECHI", "ASITECIND", "ASITECSOFT", "ASITECH", "ASITECINDIA", "ASITECHNO", "ASILIMITED", "ASILIM", "ASIVISION", "ASIWAREHOUSE", "ASIWELDINGELECTRODE", "ASIWHOLEIN", "ASKSL", "ASLEEP", "ASLOGISTIC", "ASLT", "ASLTECH", "ASMCCONSULT", "ASMBUILD", "ASMECH", "ASMED", "ASMETALLURGICAL", "ASMILLSPEC", "ASMITECH", "ASML", "ASMTECH", "ASNETGLOBAL", "ASNPL", "ASONEPHARMA", "ASOPTECH", "ASPAMAN", "ASPAKDREAMS", "ASPALATEX", "ASPALTECH", "ASPATEX", "ASPAU", "ASPAUTECH", "ASPBULLION", "ASPBUILDERS", "ASPCAPITAL", "ASPCARDS", "ASPCHEM", "ASPCHEMICAL", "ASPCONCRETEMIX", "ASPCONST", "ASPCONSTRUCTION", "ASPCONSTRUCTIONINDIA", "ASPCORP", "ASPDIS", "ASPDS", "ASPDYES", "ASPELIGHT", "ASPENERGY", "ASPENTECH", "ASPERE", "ASPERTECH", "ASPFUTURES", "ASPGLOBALTECH", "ASPHALT", "ASPHYS", "ASPIND", "ASPINSTEEL", "ASPINTERLINKS", "ASPINVEST", "ASPIRATION", "ASPJC", "ASPJEWEL", "ASPJEWELRY", "ASPJOURNAL", "ASPKANCH", "ASPKMC", "ASPLEAD", "ASPLEX", "ASPLIMITED", "ASPMECHTECH", "ASPMEDICAL", "ASPMOTOR", "ASPMOULD", "ASPMSRTC", "ASPNEU", "ASPNEUTRAL", "ASPNFO", "ASPNNL", "ASPNOL", "ASPNOTE", "ASPNTECH", "ASPNUVOX", "ASPOLITE", "ASPOLYTECH", "ASPOLYM", "ASPOMALT", "ASPONLINE", "ASPOPEN", "ASPOPENTECH", "ASPOPENWORLD", "ASPORBAN", "ASPORBIT", "ASPORN", "ASPOUTLOOK", "ASPPAPER", "ASPPARADE", "ASPPHARMAGROUP", "ASPPHARMA", "ASPPHARMAS", "ASPPHC", "ASPPLATE", "ASPPLAYED", "ASPPLAZA", "ASPPLTD", "ASPPLY", "ASPPM", "ASPPMC", "ASPPMED", "ASPPMLTD"]]
